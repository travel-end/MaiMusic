...
object Constants {
    ...
    const val SL_3 = 3//四明有狂客，风流贺季真。长安一相见，呼我谪仙人 5
    ...
    const val SL_10 = 10//绿蚁新焙酒，红泥小火炉。晚来天欲雪，能饮一杯无？ 8
...
//    const val SL_32 = 32// 江畔何人初见月，江月和年初照人？人生代代无穷已，江月年年望相似 2
    ...
    const val SL_36 = 36// 杨花落尽子规啼，闻道龙标过五溪。我寄愁心与明月，随风直到夜郎西 5
    const val SL_37 = 37// 知君用心如日月，事夫誓拟同生死。还君明珠双泪垂，恨不相逢未嫁时 6
    ...
    const val SL_44 = 44// 清晨入古寺，初日照高林。曲径通幽处，禅房花木深 8
    const val SL_45 = 45//昔我往矣，杨柳依依。今我来思，雨雪霏霏 2
    const val SL_46 = 46//风雨如晦，鸡鸣不已。既见君子，云胡不喜 5
    const val SL_47 = 47//回乐峰前沙似雪，受降城外月如霜。不知何处吹芦管，一夜征人尽望乡 2
    const val SL_48 = 48//千山鸟飞绝，万径人踪灭。孤舟蓑笠翁，独钓寒江雪 8
    const val SL_49 = 49//月落乌啼霜满天，江枫渔火对愁眠。姑苏城外寒山寺，夜半钟声到客船 7
    const val SL_50 = 50//寂寞空庭春欲晚，满地梨花不开门 1
    const val SL_51 = 51// 花径不曾缘客扫，蓬门今始为君开 9
    const val SL_52 = 52//红豆生南国，春来发几枝 7
    const val SL_53 = 53//衰兰送客咸阳道，天若有情天亦老 1
    const val SL_54 = 54//银烛秋光冷画屏，轻罗小扇扑流萤。天阶夜色凉如水，坐看牵牛织女星 8
    const val SL_55 = 55//去年今日此门中，人面桃花相映红。人面不知何处去，桃花依旧笑春风 7
    const val SL_56 = 56//竹坞无尘水滥清，相思迢递隔重城。秋阴不散霜飞晚，留得枯荷听雨声 2
    const val SL_57 = 57//永忆江湖归白发，欲回天地入扁舟 5
    const val SL_58 = 58//曾经沧海难为水，除却巫山不是云 1
    const val SL_59 = 59//人生若只如初见，何事秋风悲画扇。等闲变却故人心，却道故人心易变 7
    const val SL_60 = 60//西风吹老洞庭波，一夜湘君白发多。醉后不知天在水，满船清梦压星河 8
    const val SL_61 = 61//玲珑骰子安红豆，入骨相思知不知 1
    const val SL_62 = 62//君问归期未有期，巴山夜雨涨秋池。何当共剪西窗烛，却话巴山夜雨时 9
    const val SL_63 = 63//人生自是有情痴，此恨不关风与月 6
    const val SL_64 = 64//君埋泉下泥销骨，我寄人间雪满头 5
