...
import wind.widget.taglayout.listener.OnTagSelectedListener;
import wind.widget.taglayout.tags.MutSelectedTagView;
...
public class TagFlowLayout extends NestedScrollView {
    //默认最小最大布局高度，单位dp
    private static final float DEFAULT_MIN_LAYOUT_HEIGHT = 30;
    private static final float DEFAULT_MAX_LAYOUT_HEIGHT = 100;
    //默认标签之间的间距
    ...
    //标签容器
    private TagNestedScrollView hsv_tag_content;
    //点击展开收回的容器
    ...
    private void initViews() {
        ...
        hsv_tag_content = (TagNestedScrollView) findViewById(R.id.hsv_tag_content);
