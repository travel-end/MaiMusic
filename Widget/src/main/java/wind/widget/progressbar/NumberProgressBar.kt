package wind.widget.progressbar
...
class NumberProgressBar @JvmOverloads constructor(
     ...
     * Listener
     */
    private var mListener: OnNumberProgressBarListener? = null
    ...
    fun setOnProgressBarListener(listener: OnNumberProgressBarListener) {
        mListener = listener
    }
